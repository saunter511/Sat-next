...
const Serach = () => {
    ...
    const findMe = () => {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            +lat+"+"
            +lng+"&key=36e2ec56f5314e6b801a8e0da6f1f181";
            ...
            fetch(url).then(res => res.json()).then(d =>{
              setValue("location",d.results[0].components.city)
                ...
                fetch(satUrl).then(res =>res.json()).then(data =>{
                  setData(data)
                  setIsLoading(false)
               })  
              });
    ...
    return(
        ...
        <SerachContainer>
            <TextInput name="location" reference={register} placeholder="Type your location" />
